...
<body>
<form id="form1" name="form1" method="post" action="putMoney.action">
<table width="60%" border="0" cols="" bgcolor="#3787C1" align="center">
  ...
  <tr>
    <td height="85" colspan="2"><div align="center" class="STYLE4">
      <p class="STYLE1">请放入你的钞票</p>
      <p class="STYLE2">输入钞票前，请确认周边安全</p>
    </div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="70" align="left"><input name="Submit22" type="button" class="STYLE2" value="返回" onclick="window.location.href='funtion.jsp'"/></td>
