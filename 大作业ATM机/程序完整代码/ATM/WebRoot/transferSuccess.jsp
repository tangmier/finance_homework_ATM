...
<table width="60%" border="0" cols="" bgcolor="#3787C1" align="center">
  ...
  <tr>
    <td height="85" colspan="2"><div align="center" class="STYLE4">
      <p class="STYLE1">成功转入<s:property value="#request.bank"/>账号<s:property value="#request.otherCardID"/></p>
      </div></td>
  </tr>
  <tr>
    <td height="76" colspan="2">
      <div align="center"><span class="STYLE8">￥<s:property value="#request.number"/></span></div>    </td>
  </tr>
  <tr>
